...
$freelancers = ORM::for_table($config['db']['pre'].'user')->where('user_type','beautician')->count();
$employers = ORM::for_table($config['db']['pre'].'user')->where('user_type','user')->count();
?>
        ...
        <div class="row">
                ...
                <a class="card bg-purple bg-inverse" href="#">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">Total Registrations</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-cyan bg-inverse" href="#">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">Beautisians</p>
            ...
            <div class="col-sm-6 col-lg-3">
                <a class="card bg-teal bg-inverse" href="#">
                    <div class="card-block clearfix">
                        <div class="pull-right">
                            <p class="h6 text-muted m-t-0 m-b-xs">Users</p>
                        ...
                        <div class="table-responsive">
                            <table class="table ">
                                ...
                                foreach ($rows as $info) {
                                    ...
                                    $status = $info['status'];
                                    $type = $info['user_type'] == 'beautician' ? 'Beautician': 'User';
                                    if ($status == "0"){
