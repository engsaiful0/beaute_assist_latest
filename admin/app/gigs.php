                ...
                <div id="js-table-list">
                    <table class="js-table-checkable table table-vcenter table-hover" id="ajax_datatable" data-jsonfile="<?php echo $url; ?>">
                        ...
                        <tr>
                            ...
                            <th class="hidden-xs hidden-sm sortingNone" style="width:100px">Sales</th>
                            <th class="hidden-xs hidden-sm sortingNone" style="width:100px">In queue</th>
                            <th class="hidden-xs hidden-sm" style="width:100px">Created</th>
...
<div class="site-action">
    ...
    <div class="site-action-buttons">
        <button type="button" data-ajax-response="deletemarked" data-ajax-action="deletePost"
