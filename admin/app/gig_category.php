            ...
            <form>
                ...
                <div class="modal-body">
                    <div class="loader" style="text-align: center;">
                        <img src="<?php echo SITEURL; ?>includes/assets/images/loading.gif"/>
                    </div>
                                    ...
                                    <div class="row">
                                        <div id="quickad-sidebar" class="col-sm-4">
                                            <div id="quickad-categories-list" class="quickad-nav">
                                                <div class="quickad-nav-item active quickad-category-item quickad-js-all-services" data-post_type="gig">
                                                    <div class="quickad-padding-vertical-xs">All Service Categories</div>
                                                </div>
                                                <ul id="quickad-category-item-list" class="ui-sortable">
                                                    ...
                                                    foreach ($rows as $row) {
                                                        ...
                                                        ?>
                                                        <li class="quickad-nav-item quickad-category-item" data-post_type="gig" data-category-id="<?php echo $catid; ?>">
                                            ...
                                            <form method="post" id="new-category-form" style="display: none">
                                                <div class="form-group quickad-margin-bottom-md">
                                                    ...
                                                    <input class="form-control" id="quickad-category-slug" value="service" type="hidden" name="post_type"/>
                                                    <div class="form-field form-required">
