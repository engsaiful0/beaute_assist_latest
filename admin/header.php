                ...
                <div class="app-layout-drawer-scroll">
                    ...
                    <nav class="drawer-main">
                        <ul class="nav nav-drawer">
                            ...
                            <li class="nav-item">
                                <a href="<?php echo ADMINURL; ?>app/meeting_schedule.php"><i class="ion-ios-list-outline"></i>Meeting Schedule</a>
                            </li>
                            <li class="nav-item">
                                <a href="<?php echo ADMINURL; ?>app/subscriber.php"><i class="ion-ios-list-outline"></i>Subscriber</a>
                            </li>
                            <li style="display: none;" class="nav-item nav-drawer-header">Manage Service</li>
                            <li style="display: none;" class="nav-item">
                                <a href="<?php echo ADMINURL; ?>app/gig_category.php"><i class="ion-ios-list-outline"></i>Service Category</a>
                            </li>
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/gig_custom_field.php"><i class="ion-android-options"></i> Service Custom Fields</a>-->
                            <!--                        </li>-->
                            <li style="display: none;" class="nav-item nav-item-has-subnav">
                                <a href="#"><i class="ion-briefcase"></i>Services</a>
                                <ul class="nav nav-subnav">
                                    ...
                                    <li><a href="<?php echo ADMINURL; ?>app/gigs.php">All Services List</a></li>
                                </ul>
                            </li>
                            ...
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/projects.php?status=open">Open</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/projects.php?status=under_development">Ongoing</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/projects.php?status=completed">Completed</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/projects.php?status=close">Closed</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/projects.php">All Projects List</a></li>-->
                            <!--                            </ul>-->
                            <!--                        </li>-->
                            ...
                            <!--                            <ul class="nav nav-subnav">-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/post_active.php">Active Jobs</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/post_pending.php">Pending Jobs</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/post_hidden.php">Hidden by User</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/post_resubmit.php">Resubmitted Jobs</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/post_expire.php">Expire Jobs</a></li>-->
                            <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--app/posts.php">All Jobs List</a></li>-->
                            <!--                            </ul>-->
                            <!--                        </li>-->
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/companies.php"><i class="fa fa-bank"></i> Companies</a>-->
                            <!--                        </li>-->
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/post-types.php"><i class="fa fa-suitcase"></i> Job Types</a>-->
                            <!--                        </li>-->
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/salary-types.php"><i class="fa fa-dollar"></i> Salary Types</a>-->
                            <!--                        </li>-->
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/resumes.php"><i class="fa fa-paperclip"></i> Resumes</a>-->
                            <!--                        </li>-->
                            ...
                            <!--                        <li class="nav-item">-->
                            <!--                            <a href="--><?php //echo ADMINURL; 
                                                                        ?><!--app/custom_field.php"><i class="ion-android-options"></i> Custom Fields</a>-->
                            <!--                        </li>-->
                            <li class="nav-item nav-item-has-subnav">
                                ...
                                <ul class="nav nav-subnav">
                                    ...
                                    <li>
                                        <a href="<?php echo ADMINURL; ?>global/promo_codes.php">Promo Code</a>
                                    </li>
                            ...
                            <li class="nav-item nav-item-has-subnav">
                                ...
                                <ul class="nav nav-subnav">
                                    ...
                                    <!--                                <li><a href="--><?php //echo ADMINURL; 
                                                                                        ?><!--app/chat_setting.php">Setting</a></li>-->
                                </ul>
                            </li>
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="collapse navbar-collapse" id="header-navbar-collapse">
                            <ul id="main-menu" class="nav navbar-nav navbar-left">
                                ...
                                <!--                            <li><a href="--><?php //echo ADMINURL; 
                                                                                ?><!--global/plugins.php">Plugins</a></li>-->
