...
if (count($result) > 0) {
    ...
    foreach ($result as $info1 ) {
        ...
        $item[$info1['id']]['favorite'] = check_product_favorite($info1['id'],'service');
...
$quickchat_url = $link['MESSAGE']."/?postid=$postid&posttype=service&userid=$qcuserid";
HtmlTemplate::display('service_detail', array(
    ...
    'item_favorite' => check_product_favorite($post_id,'service'),
