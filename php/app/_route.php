...
$router->map('GET|POST','/beautassists/?', $app_dir.'beautassists.php');
...
$router->map('GET|POST','/service/[i:id]?/[*:slug]?/?', $app_dir.'service_detail.php');
$router->map('GET|POST','/edit-service/[i:id]?/[a:action]?/?', $app_dir.'service_edit.php');
$router->map('GET|POST','/post-service/?', $app_dir.'service_post.php');
$router->map('GET|POST','/services/?', $app_dir.'service_search.php');
$router->map('GET|POST','/services/[*:cat]?/[*:subcat]?/?', $app_dir.'service_search.php');
$router->map('GET|POST','/manage-service/[*:page]?/?', $app_dir.'service_manage.php');
$router->map('GET|POST','/service-orders/[i:id]?', $app_dir.'service_order.php');
$router->map('GET|POST','/meeting-schedule-user/[*:page]?/?', $app_dir.'meeting_schedule_user.php');
$router->map('GET|POST','/meeting-schedule-beautician/[*:page]?/?', $app_dir.'meeting_schedule_beautician.php');