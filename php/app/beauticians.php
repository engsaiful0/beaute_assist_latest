...
if(count($_GET) >= 1){
    ...
    $Pagelink .= "?".$get;
    $pagging = pagenav($total,$page_number,$limit,$link['BEAUTICIANS'].$Pagelink,1);
}else{
    $pagging = pagenav($total,$page_number,$limit,$link['BEAUTICIANS']);
}
$country_code = check_user_country();
//Print Template
HtmlTemplate::display('beauticians', array(
    'pagetitle' => $Pagetitle,
    'items' => $items,
    'usersfound' => $total,
