...
if(checkloggedin())
{
    ...
    if(isset($_POST['submit']))
    {
        ...
        if($errors == 0)
        {
            ...
            $person->set('hourly_rate', $_POST["hourly_rate"]);
    ...
    if(isset($_POST['billing-submit']))
    {
            ...
            update_user_option($_SESSION['user']['id'],'paypal', validate_input($_POST['paypal']));
            update_user_option($_SESSION['user']['id'],'bank_details', validate_input($_POST['bank_details']));
            ...
            transfer($link['BILLING'],__("Billing Setting Saved Successfully"),__("Billing Setting Saved Successfully"));
            exit;
    ...
    if(isset($_POST['submit'])) {
        ...
        $email_field = $ses_userdata['email'];
        $hourly_rate_field = $ses_userdata['hourly_rate'];
        $username_field = $_SESSION['user']['username'];
        $username_error = '';
        $email_error = '';
        $password_error = '';
    ...
    $cat_dropdown = get_categories_dropdown();
    //Print Template
    HtmlTemplate::display('global/billing', array(
        'hourly_rate_field' => $hourly_rate_field,
        ...
        'paypal' => get_user_option($_SESSION['user']['id'],'paypal'),
        'bank_details' => get_user_option($_SESSION['user']['id'],'bank_details'),
