...
if(checkloggedin())
{
    if(isset($_REQUEST['upgrade']))
    {
        ...
        $amount_without_dollar_sign=$price;
        ...
        if(isset($_POST['payment_method_id']))
        {
            ...
            if($_REQUEST['upgrade'] == 'trial'){
                ...
                $_SESSION['quickad'][$access_token]['amount'] = $price-$discount_amount;
                $_SESSION['quickad'][$access_token]['base_amount'] = $base_amount-$discount_amount;;
                ...
                if($_POST['payment_method_id'] == "wallet"){
                    ...
                    $amount_without_dollar_sign=$base_amount-$discount_amount;;
                ...
                if($folder == 'paypal' || $folder == 'stripe'){
                    ...
                    $_SESSION['quickad'][$access_token]['billing_type'] = $_POST['billed-type'];
        ...
        else
        {
            ...
            HtmlTemplate::display('global/membership_payment', array(
                ...
                'order_title' => $title,
                'amount' => $amount,
                'amount_without_dollar_sign'=>$amount_without_dollar_sign,
                'price' => $price,
