...
else
{
    ...
    {
        $error = __("Your email has not been verified yet. Please verify now.");
        //Print Template
        HtmlTemplate::display('global/login', array(
            'ref' => $ref,
            'error' => $error
    ...
    elseif($loggedin['email_verify'] == 0)
    {
        $error = __("Your email has not been verified yet by you. Please check your email and verify now.");
        //Print Template
        HtmlTemplate::display('global/login', array(
            'ref' => $ref,
            'error' => $error
