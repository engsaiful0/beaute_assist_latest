...
if (isset($access_token)) {
    ...
    $base_amount = isset($_SESSION['quickad'][$access_token]['base_amount']) ? $_SESSION['quickad'][$access_token]['base_amount'] : $_SESSION['quickad'][$access_token]['amount'];
    $plan_interval = $_SESSION['quickad'][$access_token]['plan_interval'];
    $payment_mode = $_SESSION['quickad'][$access_token]['payment_mode'];
    $package_id = isset($_SESSION['quickad'][$access_token]['sub_id']) ? $_SESSION['quickad'][$access_token]['sub_id'] : null;
   ...
   // die($plan_interval);
    ...
    } else if ($plan_interval == 'MONTHLY' || $plan_interval == 'YEARLY') {
    ...
    switch ($action) {
            ...
            switch ($payment_mode) {
                ...
                case 'recurring':
                    ...
                    $payment_definition->setName('Regular Payments')
                        ...
                        ->setCycles($plan_interval == 'MONTHLY' ? '1' : '12')
        ...
        case 'paypal_ipn':
            ...
            if ($_GET['payment_mode'] == 'one_time') {
                ...
                $_SESSION['quickad'][$access_token]['txn_id'] = $payment_id;
                try {
            ...
            /* Return confirmation processing recurring payment */ elseif ($_GET['payment_mode'] == 'recurring') {
