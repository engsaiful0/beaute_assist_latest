...
if (isset($access_token)) {
    ...
    elseif($payment_type == "premium" || $payment_type == "banner-advertise" || $payment_type == "deposit" || $payment_type == "order_service") {
        $payment_mode = "one_time";
        ...
        $plan_id = isset($_SESSION['quickad'][$access_token]['plan_id']) ? $_SESSION['quickad'][$access_token]['plan_id'] : null;
