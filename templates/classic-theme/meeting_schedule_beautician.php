                                    ...
                                    ?>
                                        <td >
                                            ...
                                            ?>
                                                <form id="meeting_accept_form" method="post">
                                                    ...
                                                    <button type="button" onclick="accept_status_save()" style="background-color: #E6B4AB;" href="" class="button">Accept</button>
                                                </form>

                                            <?php
                                            } else {
                                            ?>
                                                <div class="" style="background-color:#E6B4AB;color: white">
                                        ...
                                        <td > <?php
                                                ...
                                                <form id="meeting_decline_form" method="post">
                                                    <input name="id" value="<?php echo $item['id'] ?>" type="hidden">
                                                    <button type="button" onclick="decline_status_save()" href="" style="background-color:#9C6A61" class="button">Decline</button>
                                                </form>
                                            <?php
                                                            } else {
                                            ?>
                    ...
                    if (confirm('Are you sure to accept the meeting?')) {
                        ...
                        jQuery.ajax({
                            ...
                            success: function(data) {
                                if (data != 0) {
                                    Snackbar.show({
                                        text: 'Meeting has been accepted successfully.'
                                    });
                                    $("#title").val('');
                                    $("#description").val('');
                                    $("#start_datetime").val('');
                    ...
                    if (confirm('Are you sure to decline the meeting?')) {
                        ...
                        jQuery.ajax({
                            ...
                            success: function(data) {
                                if (data != 0) {
                                    Snackbar.show({
                                        text: 'Meeting has been declined successfully.'
                                    });
                                    $("#title").val('');
                                    $("#description").val('');
                                    $("#start_datetime").val('');
