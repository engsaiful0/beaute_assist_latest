                ...
                <div class="col-xl-2 col-lg-2 col-md-4">
                    <div class="footer-links">
                        ...
                        <ul>
                            ...
                            // }
                            ?>
                            <!--                            <li><a href="--><?php //url("ADVERTISE_HERE") 
                                                                            ?><!--">--><?php //_e("Advertise Here") 
                                                                                        ?><!--</a></li>-->
                        </ul>
                    </div>
                </div>
            ...
            <div class="row" style="padding:10px;">
                <form method="POST" id="subscriber_form">
                    ...
                    <div class="row gutters-10">
                        <div class="col-12">
                            <h3 style="color:white">Subscribe to our newsletter for regular updates about Offers, Coupons & more.</h3>
                        </div>
                        <div class="col-4">
                            <input id="email" type="email" class="form-control border-secondary rounded-0 text-white w-100 bg-transparent" placeholder="Your Email Address" name="email" required="" data-listener-added_db8a1453="true">
                        </div>
                        <div class="col-2">
                            <button onclick="subscriber_save()" id="login-button" class="button full-width button-sliding-icon ripple-effect" type="button" name="submit">Subscribe <i class="icon-feather-arrow-right"></i></button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="popup-tab-content" id="login">
                ...
                <form id="login-form" method="post" action="<?php _esc($config['site_url']) ?>login?ref=<?php _esc($ref_url) ?>">
                    ...
                    <div class="input-with-icon-left">
                        ...
                        <input type="text" class="input-text with-border" name="username" id="username" placeholder="<?php _e("Username") ?> / <?php _e("Email Address") ?>" required />
                    </div>

                    <div class="input-with-icon-left">
                        <i class="la la-unlock"></i>
                        <input type="password" class="input-text with-border" name="password" id="password" placeholder="<?php _e("Password") ?>" required />
                    </div>
...
<script>
    function subscriber_save() {
        ...
        jQuery.ajax({
            url: "<?php _esc($config['app_url']) ?>subscriber_datasave.php",
            data: data,
            type: "POST",
            success: function(data) {
                if (data != 0) {
                    Snackbar.show({
                        text: 'Subscriber has been saved successfully!'
                    });
                    $("#email").val('');
                } else {
                    Snackbar.show({
