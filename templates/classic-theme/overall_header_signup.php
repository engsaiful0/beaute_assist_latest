                    ...
                    <ul id="countries" class="column col-md-12 col-sm-12 cities">
                        <?php foreach ($countrylist as $country) { ?>
                            <li data-name="<?php _esc($country['name']); ?>">
                                ...
                                <a href="<?php url("HOME") ?>/<?php _esc($country['lang']); ?>/<?php _esc($country['lowercase_code']); ?>" data-id="<?php _esc($country['id']); ?>" data-name="<?php _esc($country['name']); ?>"> <?php _esc($country['name']); ?></a>
                            </li>
                        <?php } ?>
                    </ul>
                </div>
                    ...
                    <div class="left-side">
                        ...
                        <nav id="navigation">
                            <ul id="responsive">
                                ...
                                ?>
                                    <li>
                                        <a href="#countryModal" class="country-flag popup-with-zoom-anim" title="<?php _e("Change Country") ?>" data-tippy-placement="right">
                                ...
                                if ($is_login) {
                                ?>
                                    <li style="display: none;" class=""><a href="<?php url("BEAUTASSIST") ?>"><?php _e("Beautassists") ?></a>
                                    <li style="display: none;" class=""><a href="<?php url("SEARCH_SERVICES") ?>"><?php _e("Services") ?></a>
                                    <li style="display: none;" class=""><a href="<?php url("BLOG") ?>"><?php _e("Blog") ?></a></li>
                                    <li class=""><a href="<?php url("HOME") ?>"><?php _e("Home") ?></a></li>
                                    <li class=""><a href="<?php url("DASHBOARD") ?>"><?php _e("Dashboard") ?></a></li>
                                                ...
                                                <ul>
                                                    ...
                                                    ?>
                                                        <li class="notifications-not-read">
                                                            ...
                                                            <?php } elseif ($note['nottype'] == "milestone_request_release") { ?>
                                                                <a href="<?php url("MILESTONE") ?>/<?php _esc($id) ?>">
                                                                    <span class="notification-icon"><i class="icon-material-outline-assignment"></i></span>
                                                            ...
                                                            <?php } elseif ($note['nottype'] == "milestone_released") { ?>
                                                                <a href="<?php url("MILESTONE") ?>/<?php _esc($id) ?>">
                                                                    <span class="notification-icon"><i class="icon-material-outline-assignment"></i></span>
                                                            ...
                                                            <?php } elseif ($note['nottype'] == "deposit") { ?>
                                                            ...
                                                            <?php } elseif ($note['nottype'] == "new_order") { ?>
                                ...
                                <div class="header-notifications user-menu">
                                    ...
                                    <div class="header-notifications-dropdown">
                                            ...
                                            <div class="user-details">
                                                ...
                                                <div class="user-name">
                                                    <?php _esc($fullname); ?> <span>
                                                        <?php
                                                        $usertype = $usertype == 'user' ? 'User' : 'Beautassit';
                                                        _esc($usertype);
                                                        ?></span>
                                        ...
                                        <ul class="user-menu-small-nav">
                                            ...
                                            ?>
                                                <li style="display: none;"><a href="<?php url("MESSAGE") ?>"><i class="icon-feather-message-circle"></i> <?php _e("Message") ?></a></li>
                                            <?php } ?>
                                            <li style="display: none;"><a href="<?php url("ACCOUNT_SETTING") ?>"><i class="icon-material-outline-settings"></i> <?php _e("Account Setting") ?></a></li>
                        ...
                        <div class="header-widget d-none d-lg-block">
                            <nav id="navigation">
                                <ul>
                                    ...
                                    ?>
                                        <li>
                                            <a href="#sign-in-dialog" class="popup-with-zoom-anim"><?php _e("Login") ?></a>
                                        </li>
