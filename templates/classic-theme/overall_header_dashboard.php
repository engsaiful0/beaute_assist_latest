                    ...
                    <nav id="navigation">
                        <ul id="responsive">
                            ...
                            <?php
                                if($is_login){
                                    ?>
                            <li class=""><a href="<?php url("BEAUTASSIST") ?>"><?php _e("Beautassists") ?></a>
                            <li class=""><a href="<?php url("SEARCH_SERVICES") ?>"><?php _e("Services") ?></a>
                            <li class=""><a href="<?php url("BLOG") ?>"><?php _e("Blog") ?></a>
                                        ...
                                        <div class="user-details">
                                            ...
                                            <div class="user-name">
                                                <?php _esc($fullname);?> <span>
                                                    <?php
                                                    $usertype = $usertype == 'user' ? 'User': 'Beautisian';
                                                    _esc($usertype);
                                                    ?></span>
