...
?>
    <form method="get" action="<?php url("beauticians") ?>" name="locationForm" id="ListingForm">
        <div id="titlebar">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2><?php _e("We found") ?> <?php _esc($usersfound)?> <?php _e("Beauticians") ?></h2>
                        <!-- Breadcrumbs -->
            ...
            <div class="row">
                ...
                <div class="col-xl-9 col-lg-8 content-left-offset">
                    ...
                    <div class="notify-box margin-top-15">
                        <span class="font-weight-600"><?php _esc($usersfound) ?> <?php _e("Beauticians Found") ?></span>
                    </div>
