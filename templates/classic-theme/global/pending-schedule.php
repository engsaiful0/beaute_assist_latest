            ...
            <div class="row">
                ...
                <div class="col-xl-12">
                    <div class="dashboard-box margin-top-0">
                        <!-- Headline -->
                        <div class="headline">
                            <h3><i class="icon-material-outline-assignment"></i> <?php _e("Pending Schedule") ?></h3>
                        </div>
                            ...
                            <table id="js-table-list" class="basic-table dashboard-box-list">
                                ...
                                foreach ($items as $item) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div style="background-color:#E6B4AB;color: white;padding-left:5px;padding-right:5px">
