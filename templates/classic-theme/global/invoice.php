    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <p>
                ...
                if($config['invoice_admin_custom_name_1'] != "" && $config['invoice_admin_custom_value_1'] != "")
                    echo '<strong>'._esc($config['invoice_admin_custom_name_1'],false).'</strong> '._esc($config['invoice_admin_custom_value_1'],false).'<br>';

                if($config['invoice_admin_custom_name_2'] != "" && $config['invoice_admin_custom_value_2'] != "")
