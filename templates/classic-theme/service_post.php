...
<?php include_once TEMPLATE_PATH . '/dashboard_sidebar.php'; ?>
                    ...
                    <div class="tg-thememodalcontent">
                        ...
                        <div id="tg-dbcategoriesslider"
                            ...
                            <?php foreach ($category as $cat) { ?>
                                <div class="tg-category <?php _esc($cat['selected']) ?>"
                                     data-ajax-catid="<?php _esc($cat['id']) ?>"
            ...
            <div class="top-navbar-container">
                <nav class="quick-breadcrumbs top-navbar wizard quick-breadcrumbs-progress">
                    ...
                    <span class="quick-breadcrumbs-icon quick-breadcrumbs-icon-highlighted">
                        ...
                        <svg width="8" height="16" viewBox="0 0 8 16" xmlns="http://www.w3.org/2000/svg"><path
                        ...
                        <li class="pricing">
                            ...
                            <span class="quick-icon quick-breadcrumbs-separator" style="width: 12px; height: 12px;"><svg
                ...
                <div class="save-btn-container save-and-preview">
                    ...
                    <span class="sep">|</span>
                    <button type="button"
                            class="naked-button co-blue text-bold"><?php _e("Save &amp; Preview") ?></button>
                </div>
            </div>
        </div>
                    ...
                    <div class="col-xl-9 col-md-12">
                        ...
                        <div class="payment-confirmation-page dashboard-box margin-top-0 padding-top-0 margin-bottom-50"
                            ...
                            <div class="content with-padding padding-bottom-10">
                                ...
                                <p><?php _e("Your service successfully uploaded. Please wait for approval. Thanks") ?></p>
                            </div>
                        </div>
                        <form id="gig-overview-form" action="" method="post"
                            ...
                            <div class="dashboard-box margin-top-30">
                                <!-- Headline -->
                                <div class="headline">
                                    <h3><i class="icon-feather-briefcase"></i><?php _e("Service overview") ?></h3>
                                </div>
                                <div class="content with-padding padding-bottom-10">
                                    <div class="row">
                                        <div class="col-xl-12">
                                                ...
                                                <div class="form-group selected-product" id="change-category-btn"
                                                    ...
                                                    <ul class="select-category list-inline">
                                                        ...
                                                        <li class="active"><a href="#categoryModal"
                                                                        ...
                                                                        class="icon-feather-edit"></i> <?php _e("Edit") ?>
                                                            </a></li>
                                                    </ul>
                                            ...
                                            <div class="submit-field">
                                                ...
                                                <p><?php _e("As your Service storefront, your title is the most important place to include keywords that buyers would likely use to search for a service like yours.") ?></p>
                                                <input type="text" class="with-border" name="title">
                                            </div>

                                            <div class="submit-field">
                                                <h5><?php _e("Service summary") ?> *</h5>
                                                <p><?php _e("Briefly explain what sets you and your service apart.") ?>
                                                    *</p>
                                                ...
                                                <section class="quick-gig-pricing-section">
                                                    ...
                                                    <div class="quick-gig-pricing-container">
                                                        <table class="quick-gig-pricing-table">
                                                            ...
                                                            <tr>
                                                                <td class="first-table-col">
                                                                    <section
                                                                            class="pkg-title-education table-tooltip-on-hover">
                                                                        <div class="education-tooltip box-shadow-z4">
                                                                            ...
                                                                            <ul>
                                                                                ...
                                                                                <li>
                                                                                    <b><?php _e("For example") ?>
                                                                                        :</b> <?php _e("2D or 3D cover, Print-Ready Version") ?>
                                                                                </li>
                                                                            </ul>
                                                                        </div>
                                                                    </section>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-title-input quick-custom-field"
                                                                                name="basic_plan_title" data-req="1"
                                                                                maxlength="35"
                                                                                placeholder="<?php _e('Name your package') ?>"><?php _e('Basic') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                               data-tippy-placement="top"
                                                                               title="<?php _e('Required') ?>"></i>
                                                                        </div>
                                                                    </div>
                                                                </td>
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-title-input quick-custom-field"
                                                                                data-req="1" name="standard_plan_title"
                                                                                maxlength="35"
                                                                                placeholder="<?php _e('Name your package') ?>"><?php _e('Standard') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-title-input quick-custom-field"
                                                                                data-req="1" name="premium_plan_title"
                                                                                maxlength="35"
                                                                                placeholder="<?php _e('Name your package') ?>"><?php _e('Premium') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                            ...
                                                            <tr>
                                                                <td class="first-table-col">
                                                                    <section
                                                                            class="pkg-description-education table-tooltip-on-hover">
                                                                        <div class="education-tooltip box-shadow-z4">
                                                                            <header>
                                                                                <div class="icn-lightbulb-wrapper">
                                                                                    <i class="fa fa-lightbulb-o"></i>
                                                                            ...
                                                                            <p>
                                                                                <b><?php _e('For example') ?>
                                                                                    :</b> <?php _e('This (Full Logo Design) package includes a standard logo design with 4 revisions and the source file.') ?>
                                                                            </p>
                                                                        </div>
                                                                    </section>
                                                                </td>
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-description-input quick-custom-field"
                                                                                data-req="1" name="basic_plan_desc"
                                                                                maxlength="100"
                                                                                placeholder="<?php _e('Describe the details of your offering') ?>"><?php _e('Basic') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-description-input quick-custom-field"
                                                                                data-req="1" name="standard_plan_desc"
                                                                                maxlength="100"
                                                                                placeholder="<?php _e('Describe the details of your offering') ?>"><?php _e('Standard') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <textarea
                                                                                class="price-description-input quick-custom-field"
                                                                                data-req="1" name="premium_plan_desc"
                                                                                maxlength="100"
                                                                                placeholder="<?php _e('Describe the details of your offering') ?>"><?php _e('Premium') ?></textarea>
                                                                        <span class="edit-icon"><i
                                                                                    class="fa fa-pencil"></i></span>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                            ...
                                                            <tr>
                                                                <td class="first-table-col">
                                                                    <section
                                                                            class="pkg-duration-education table-tooltip-on-hover">
                                                                        <div class="education-tooltip box-shadow-z4">
                                                                            <header>
                                                                                <div class="icn-lightbulb-wrapper">
                                                                                    <i class="fa fa-lightbulb-o"></i>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="basic_plan_delivery_time"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('Basic Delivery Time') ?></option>
                                                                            <option value="1">
                                                                                1 <?php _e('day delivery') ?></option>
                                                                            <option value="2">
                                                                                2 <?php _e('days delivery') ?></option>
                                                                            <option value="3">
                                                                                3 <?php _e('days delivery') ?></option>
                                                                            <option value="4">
                                                                                4 <?php _e('days delivery') ?></option>
                                                                            <option value="5">
                                                                                5 <?php _e('days delivery') ?></option>
                                                                            <option value="6">
                                                                                6 <?php _e('days delivery') ?></option>
                                                                            <option value="7">
                                                                                7 <?php _e('days delivery') ?></option>
                                                                            <option value="10">
                                                                                10 <?php _e('days delivery') ?></option>
                                                                            <option value="14">
                                                                                14 <?php _e('days delivery') ?></option>
                                                                            <option value="21">
                                                                                21 <?php _e('days delivery') ?></option>
                                                                            <option value="30">
                                                                                30 <?php _e('days delivery') ?></option>
                                                                            <option value="45">
                                                                                45 <?php _e('days delivery') ?></option>
                                                                            <option value="60">
                                                                                60 <?php _e('days delivery') ?></option>
                                                                            <option value="90">
                                                                                90 <?php _e('days delivery') ?></option>
                                                                        </select>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                               data-tippy-placement="top"
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="standard_plan_delivery_time"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('Standard Delivery Time') ?></option>
                                                                            <option value="1">
                                                                                1 <?php _e('day delivery') ?></option>
                                                                            <option value="2">
                                                                                2 <?php _e('days delivery') ?></option>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="premium_plan_delivery_time"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('Premium Delivery Time') ?></option>
                                                                            <option value="1">
                                                                                1 <?php _e('day delivery') ?></option>
                                                                            <option value="2">
                                                                                2 <?php _e('days delivery') ?></option>
                                                        ...
                                                        <table class="packages-pricing-factors">
                                                            <tbody>
                                                            <tr>
                                                                <td class="first-table-col"><?php _e('Revisions') ?>
                                                                    <section
                                                                            class="pkg-pricing-factor-education table-tooltip-on-hover">
                                                                        <div class="education-tooltip box-shadow-z4">
                                                                            <header>
                                                                                <div class="icn-lightbulb-wrapper">
                                                                                    <i class="fa fa-lightbulb-o"></i>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="basic_plan_revisions"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('For Basic Plan') ?></option>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="standard_plan_revisions"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('For Standard Plan') ?></option>
                                                                            <option value="1">1</option>
                                                                            <option value="2">2</option>
                                                                            <option value="3">3</option>
                                                                            <option value="4">4</option>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field">
                                                                        <select class="selectpicker quick-custom-field"
                                                                                name="premium_plan_revisions"
                                                                                data-req="1">
                                                                            <option value=""
                                                                                    selected><?php _e('For Premium Plan') ?></option>
                                                                            <option value="1">1</option>
                                                                            <option value="2">2</option>
                                                                            <option value="3">3</option>
                                                                            <option value="4">4</option>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <div class="submit-field input-container">
                                                                        <input class="margin-bottom-0 quick-custom-field"
                                                                               type="number"
                                                                               placeholder="<?php _e('Price') ?>"
                                                                               name="basic_plan_price" data-req="1">
                                                                ...
                                                                <td>
                                                                    <div class="submit-field input-container">
                                                                        <input class="margin-bottom-0 quick-custom-field"
                                                                               type="number"
                                                                               placeholder="<?php _e('Price') ?>"
                                                                               name="standard_plan_price" data-req="1">
                                                                        <i class="icon"><?php _esc($config['currency_sign']); ?></i>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                               data-tippy-placement="top"
                                                                ...
                                                                <td>
                                                                    <div class="submit-field input-container">
                                                                        <input class="margin-bottom-0 quick-custom-field"
                                                                               type="number"
                                                                               placeholder="<?php _e('Price') ?>"
                                                                               name="premium_plan_price" data-req="1">
                                                                        <i class="icon"><?php _esc($config['currency_sign']); ?></i>
                                                                        <div class="pricing-error quick-error">
                                                                            <i class="fa fa-info-circle"
                                                                               data-tippy-placement="top"
                            ...
                            <div class="gotonext margin-top-30 margin-bottom-30">
                                <div class="clearfix">
                                    <div class="float-right">
                                        <button type="submit" id="submit_gig_button"
                                                class="oval button"><?php _e('Publish Service') ?></button>
                                    </div>
                                </div>
                            </div>
                        </form>
                        <script type="text/javascript"
                                src="<?php _esc(TEMPLATE_URL); ?>/service_fragments/js/plugins.js"></script>
                        <script type="text/javascript"
                                src="<?php _esc(TEMPLATE_URL); ?>/service_fragments/js/core.js"></script>
                        <script type="text/javascript"
                                src="<?php _esc(TEMPLATE_URL); ?>/service_fragments/js/faq.js"></script>
                        <!-- multistep form -->
    ...
    <!-- orakuploader -->
    <link type="text/css" href="<?php _esc($config['site_url']); ?>plugins/orakuploader/orakuploader.css"
          rel="stylesheet"/>
    <script type="text/javascript"
            src="<?php _esc($config['site_url']); ?>plugins/orakuploader/jquery-ui.min.js"></script>
    <script type="text/javascript"
            src="<?php _esc($config['site_url']); ?>plugins/orakuploader/orakuploader.js"></script>
    <?php if ($lang_direction == 'rtl') { ?>
        <link type="text/css" href="<?php _esc($config['site_url']); ?>plugins/orakuploader/orakuploader-rtl.css"
              rel="stylesheet"/>
    <?php } ?>
    <script>
        var watermark_image = '';
