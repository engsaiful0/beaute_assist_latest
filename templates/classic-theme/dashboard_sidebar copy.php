            ...
            <div class="dashboard-nav">
                <div class="dashboard-nav-inner">
                    <ul data-submenu-title="<?php _e("My Account") ?>">
                        ...
                        <?php
                        if($usertype == "user"){
                            echo '<li><a href="'.url("MEETING_SCHEDULE_USER",false).'"><i class="icon-material-outline-add-circle-outline"></i> '.__("Meeting Schedule").'</a></li>';
...
//                            }
                            ...
                            echo '<li><a href="'.url("MEETING_SCHEDULE_BEAUTICIAN",false).'"><i class="icon-material-outline-add-circle-outline"></i> '.__("Meeting Schedule").'</a></li>';
                            echo '<li><a href="'.url("POST_SERVICE",false).'"><i class="icon-material-outline-add-circle-outline"></i> '.__("Post Service").'</a></li>';
                        }
                        ?>
                    </ul>

                    <ul data-submenu-title="<?php _e("Organize and Manage") ?>" >
                        <li><a href="#"><i class="icon-material-outline-assignment"></i> <?php _e("Services & Orders") ?></a>
                            <ul>
                                <?php
                                if($usertype == "user"){
                                ...
                                ?>
                                <li><a href="<?php url("SERVICE_ORDERS") ?>"><?php _e("My Orders") ?></a></li>
                            </ul>
                        </li>
...
<!--                        </li>-->
                    ...
                    <ul data-submenu-title="<?php _e("Profile") ?>">
                        <li><a target="_blank" href="<?php url("PROFILE") ?>/<?php _esc($username)?>"><i
                        ...
                        if($usertype == "beautician"){
                            ...
                            echo '<li><a href="'.url("FAVUSERS",false) .'"><i class="icon-feather-heart"></i> '.__("Bookmark Beautisians") .'</a></li>';
                        }
                        ?>
                    </ul>
                    ...
                    <ul data-submenu-title="Account">
                        ...
                        <li class="hidden"><a href="<?php url("TRANSACTION") ?>"><i class="icon-feather-file-text"></i> <?php _e("Transactions") ?></a></li>
