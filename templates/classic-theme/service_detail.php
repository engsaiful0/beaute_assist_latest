        ...
        <div class="row d-flex align-items-center justify-content-between">
            <div class="col-lg-12 left">
                <ul>
                    ...
                    <li class="nav-aboutSeller"><a href="#aboutSeller"><?php _e('About The Beutassist');?></a></li>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-8 content-right-offset left">
                ...
                <div class="single-page-section" id="description">
                    <h3 class="margin-bottom-25"><?php _e('About This Service');?></h3>
                    <?php _esc($item_desc)?>
                </div>
                <div class="single-page-section" id="aboutSeller">
                    <h3 class="margin-bottom-25"><?php _e('About The Beutassist');?></h3>
                    ...
                    if($is_login){
                        if($config['quickchat_socket_on_off'] == 'on' || $config['quickchat_ajax_on_off'] == 'on'){
                            echo '<div class="contact-seller-wrapper hide-under-768px"><a href="javascript:void(0);" 
                                        ...
                                        <i class="icon-feather-message-circle"></i> '.__("Contact Beutassist").'</a></div>';
